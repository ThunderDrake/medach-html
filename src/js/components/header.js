document.addEventListener("DOMContentLoaded",() => {
  ...
  const mainOpenStyles = 'dark:bg-[#1D1D1D] bg-white transition-all duration-500 absolute top-96 md:top-64 2xl:top-32 z-50 right-0 2xl:right-5 w-full 2xl:w-fit  ';
